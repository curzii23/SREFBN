...
parser.add_argument('--pathFrom', default='D:/Work/datasets/super-resolution/Finalnew/LR/x2/DIV2K_train_LR_bicubic/X2/',
                    help='directory of images to convert')
parser.add_argument('--pathTo', default='training_data/DIV2K_decoded/DIV2K_LR_bicubic/',
