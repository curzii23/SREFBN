...
def compute_psnr(im1, im2):
    #p = psnr(im1, im2)
    p = skimage.metrics.peak_signal_noise_ratio(im1, im2)
    return p
...
def compute_ssim(im1, im2):
    ...
    s = skimage.metrics.structural_similarity(im1, im2, K1=0.01, K2=0.03, gaussian_weights=True, sigma=1.5, use_sample_covariance=False,
             multichannel=isRGB)
    return s
